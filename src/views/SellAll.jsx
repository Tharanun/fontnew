    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // Update amountProduct in the product
          const { productId, amount } = sellToDelete;
          const productResponse = await axios.put(`http://localhost:8080/product/update/${productId}`, {
          ...
          if (productResponse.status === 200) {
            ...
            console.error('Error updating Product:', productResponse.data);
            Swal.fire('Error updating Product', 'Failed to update Product', 'error');
          }
